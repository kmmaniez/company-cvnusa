...
class PostController extends Controller
{
            ...
            return DataTables::of($model)
                ...
                ->editColumn('action', function ($row) {
                    ...
                    $btn = '
                        ...
                        <a href="' . $url . '/' . $row->slug . '" target="_blank" class="btn btn-md btn-outline-secondary"><i class="fas fa-fw fa-eye"></i> Lihat</a>
    ...
    {
        // JIKA PENULIS TIDAK SAMA DENGAN USER LOGIN, AKSES DITUTUP. KECUALI SUPER/ADMIN
