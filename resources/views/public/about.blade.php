            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-5 mt-lg-0">
                    ...
                    <div id="page-slider" class="page-slider small-bg">
                        ...
                        <div class="item" style="background-image:url({{ url('assets/images/slider-pages/slide-page1.jpg') }})">
                            <div class="container">
                        ...
                        <div class="item" style="background-image:url({{ url('assets/images/slider-pages/slide-page2.jpg') }})">
                            <div class="container">
                                <div class="box-slider-content">
                                    <div class="box-slider-text">
                        ...
                        <div class="item" style="background-image:url({{ url('assets/images/slider-pages/slide-page3.jpg') }})">
                            <div class="container">
                                <div class="box-slider-content">
                                    <div class="box-slider-text">
