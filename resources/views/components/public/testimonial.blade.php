                ...
                <div id="testimonial-slide" class="testimonial-slide">
                        ...
                        <div class="quote-item">
                            ...
                            <div class="quote-item-footer">
                                <img loading="lazy" class="testimonial-thumb"
                                    src="{{ url('assets/images/clients/testimonial1.png') }}" alt="testimonial">
                    ...
                    <div class="item">
                        <div class="quote-item">
                            ...
                            <div class="quote-item-footer">
                                <img loading="lazy" class="testimonial-thumb"
                                    src="{{ url('assets/images/clients/testimonial2.png') }}" alt="testimonial">
                                <div class="quote-item-info">
                    ...
                    <div class="item">
                        <div class="quote-item">
                            ...
                            <div class="quote-item-footer">
                                <img loading="lazy" class="testimonial-thumb"
                                    src="{{ url('assets/images/clients/testimonial3.png') }}" alt="testimonial">
                                <div class="quote-item-info">
