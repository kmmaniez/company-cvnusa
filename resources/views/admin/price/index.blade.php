    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="" class="btn btn-md btn-primary mb-3" id="btnTambahHarga" data-toggle="modal" data-target="#modal-create"><i
                            ...
                            <tbody>
                                @forelse ($prices as $price)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-id="{{ $price->id }}" id="btnEditModal" class="btn btn-warning">Edit</a>
                                            <a href="#" data-id="{{ $price->id }}" id="btnHapusModal" class="btn btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                @empty
                ...
                <div class="modal-body">
                    <form id="formCreatePrice">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="custom_text_button" id="custom_text_button" placeholder="">
                        </div>
                        <div class="mb-3">
                            {{-- <label for="highlight_harga" class="form-label">Highlight Harga</label> --}}
                            {{-- <input type="checkbox" class="form-control" name="highlight_harga" id="highlight_harga" placeholder=""> --}}
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" value="on" name="highlight_harga" id="highlight_harga">
                                <label class="custom-control-label" for="highlight_harga">Highlight Harga ?</label>
                              </div>
                        </div>
                        <button class="btn btn-md btn-primary" id="btnSimpanHarga"><i class="fas fa-fw fa-save"></i>Simpan</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formEditPrice">
                        ...
                        <div class="mb-3">
                            <label for="custom_text_button_edit" class="form-label">Custom Text Button (lihat hasil)</label>
                            <input type="text" class="form-control" name="custom_text_button_edit" id="custom_text_button_edit">
                        </div>
                        <div class="mb-3">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" value="on" name="highlight_harga_edit" id="highlight_harga_edit">
                                <label class="custom-control-label" for="highlight_harga_edit">Highlight Harga ?</label>
                            </div>
                        </div>
                        <button class="btn btn-md btn-primary" id="btnUpdateHarga"><i class="fas fa-fw fa-save"></i>Update</button>
                    </form>
                </div>
            </div>
        </div>
