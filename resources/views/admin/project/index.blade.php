            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_project" id="nama_project" placeholder="name@example.com">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_project" id="nama_project" placeholder="1000 M2 X 1500 M2">
                    </div>
                    <div class="mb-3">
                        <label for="nama_project" class="form-label">Tanggal Project Selesai</label>
                        <input type="date" class="form-control" name="nama_project" id="nama_project" placeholder="name@example.com">
                    </div>
                    <div class="mb-3">
